#ifndef _LAZY_SEGMENT_TREE_FAST_H_
#define _LAZY_SEGMENT_TREE_FAST_H_
#include <cassert>
#include <vector>
...
struct segtree_lazy {
  public:
    segtree_lazy() : segtree_lazy(0) {}
    explicit segtree_lazy(int n) : segtree_lazy(std::vector<S>(n, e())) {}
    explicit segtree_lazy(const std::vector<S>& v) : _n(int(v.size())) {
...
using segtree_lazy_monoid = segtree_lazy<typename monoid::S, monoid::op, monoid::e, typename monoid::F, monoid::mapping, monoid::composition, monoid::id>;
#endif
